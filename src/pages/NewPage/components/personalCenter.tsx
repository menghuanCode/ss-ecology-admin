...
const PhoneSvg = () => (
  <svg viewBox="0 0 21 21" width="21px" height="21px">
    <g fill="#D9D9D9">
      <path d="M 4.40625 7 C 4.40625 3.68615 7.0924 1 10.4063 1 C 13.7201 1 16.4063 3.68615 16.4063 7 C 16.4063 10.3138 13.7201 13 10.4063 13 C 7.0924 13 4.40625 10.3138 4.40625 7 Z M 3 17.15 C 3 15.576 4.2592 14.3 5.8125 14.3 L 15.1875 14.3 C 16.7408 14.3 18 15.576 18 17.15 C 18 18.724 16.7408 20 15.1875 20 L 5.8125 20 C 4.25906 20 3 18.7208 3 17.15 Z" />
    </g>
  </svg>
);
const CodeSvg = () => (
